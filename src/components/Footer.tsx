      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center mb-4">
              <img src="/logo-white.svg" alt="To' Barato Logo" className="h-10 w-auto" />
              <span className="ml-2 text-2xl font-bold text-white font-poppins">To' Barato</span>
            </div>
            <p className="text-gray-400 mb-4 font-inter">
              La mejor app para ahorrar dinero en tus compras en la República Dominicana.
            </p>
          ...
          <div>
            <h3 className="text-lg font-semibold mb-4 font-poppins">Recursos</h3>
            <ul className="space-y-2 font-inter">
          ...
          <div>
            <h3 className="text-lg font-semibold mb-4 font-poppins">Contáctanos</h3>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm mb-4 md:mb-0 font-inter">
            &copy; {new Date().getFullYear()} To' Barato. Todos los derechos reservados.
          </p>
